...
flags.DEFINE_integer("output_height", 218, "The size of the output images to produce [64]")
flags.DEFINE_integer("output_width", 178, "The size of the output images to produce. If None, same value as output_height [None]")
flags.DEFINE_string("dataset", "celeb", "The name of dataset [celebA, mnist, lsun]")
