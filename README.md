...
## Pre-trained Models
- Download the pretrained model from here and save it in ```checkpoint/celeb_50_218_178/```. Use this path for generating the images.

- Our pre-trained Models are trained with ```dataset: celeb```, ```batch_size: 50```, ```output_height: 218``` and ```output_width: 178```. 
